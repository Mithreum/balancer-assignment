...
sender              = "0xACb4A8b1A53490de57d7d2e0F2375B112f791Edd"  # The owner of the incomming token
...
# 5. Parse the hexadecimal string into respective components
token_a_price = int(result_hex[2:66], 16)
token_b_price = int(result_hex[66:130], 16)
# contract_slippage = int(result_hex[130:194], 16)
...
print("Expected:", expected, "Actual:", actual, "Slippage:", slippage)
